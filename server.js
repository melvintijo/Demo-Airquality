...
for (let device of devices) {
    ...
    /////////////////////////////////////////////////////////
    source.addEventListener('Gas', eventListeners.handleGasStateChanged)
    source.addEventListener('AQIPM25', eventListeners.handleAQIPM25StateChanged)
    source.addEventListener('AQIPM100', eventListeners.handleAQIPM100StateChanged)
    source.addEventListener('AirQualityPm1', eventListeners.handleAirqualityPmStateChanged)
    source.addEventListener('AirQualityUmL', eventListeners.handleAirqualityUmLStateChanged)
